    ...
    render() {
        return (
            <tr>
                ...
                <td>
                    <VoucherEdit key={'edit-' + this.props.details.id} id={this.props.details.id} details={this.props.details} />
                    <VoucherDeleteConfirm key={'delete-' + this.props.details.id} id={this.props.details.id} />
                </td>
            </tr>
        );
    }
